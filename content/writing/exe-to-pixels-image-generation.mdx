...
<<<<<<< HEAD
  <Image
    src="/images/writing/exe-to-pixels-image-generation/windows-vm.png"
    alt="Windows VM"
    width={2348}
    height={1560}
  />
=======
  <Image src="/img/pixel/windowsVM.png" alt="Windows VM" width={2348} height={1560} />
>>>>>>> origin/main
</figure>
...
<<<<<<< HEAD
  <Image
    src="/images/writing/exe-to-pixels-image-generation/windows-program-files.png"
    alt="Windows Program Files"
    width={703}
    height={542}
  />
</figure>
...
<figure className="flex flex-col items-center">
  <Image
    src="/images/writing/exe-to-pixels-image-generation/windows-executables.png"
    alt="Windows Executables"
    width={658}
    height={722}
  />
=======
  <Image src="/img/pixel/windowsProgramfiles.png" alt="Windows Program Files" width={703} height={542} />
</figure>

<figure className="flex flex-col items-center">
  <Image src="/img/pixel/windowsExes.png" alt="Windows Executables" width={658} height={722} />
>>>>>>> origin/main
</figure>
...
<<<<<<< HEAD
  <Image
    src="/images/writing/exe-to-pixels-image-generation/generated-pixel-image.png"
    alt="Generated pixel image"
    width={1102}
    height={1064}
  />
=======
  <Image src="/img/pixel/imagePixel.png" alt="Generated pixel image" width={1102} height={1064} />
>>>>>>> origin/main
</figure>
...
<<<<<<< HEAD
  <Image
    src="/images/writing/exe-to-pixels-image-generation/generated-images.png"
    alt="Images generated"
    width={692}
    height={542}
  />
=======
  <Image src="/img/pixel/ImagesGenerated.png" alt="Images generated" width={692} height={542} />
>>>>>>> origin/main
</figure>

...
![Windows VM](/img/pixel/windowsVM.png)

Once i had the windows files i sorted them into a folder containing only the executatables for this example.

![Windows Program Files](/img/pixel/windowsProgramfiles.png)

![Windows Executables](/img/pixel/windowsExes.png)
...
![Generated pixel image](/img/pixel/imagePixel.png)
...
![Images generated](/img/pixel/ImagesGenerated.png)

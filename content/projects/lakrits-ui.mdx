...
links:
  ...
  - label: "Github"
    url: "https://github.com/paullarkiin/lakrits"
---
...
The documentation website is an important part of Lakrits UI and will in the future host all the components and the use cases.

Rather than treating documentation as something added later, the website acts as part of the development process. Allowing for a testing ground where I can see how the library works as a whole using **npm link** and **npm unlink** in different projects.

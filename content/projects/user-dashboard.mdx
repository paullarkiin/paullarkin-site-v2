...
When i got feedback on the direction, I started developing the dashboard and initally hosting it on vercel before later working with DevOps to host the solution internally with real data and test how it could work beyond the initial group.
...
Notion acts as the database source, with research pulled from different pages
via the API and converted into structured data, and reconstructed inside the
application.

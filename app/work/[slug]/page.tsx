...
export default async function ProjectPage({ params }: { params: Params }) {
  ...
  return (
    <PageShell as="article" className="py-32">
      <BackLink />
              ...
              <div className="flex flex-col gap-1">
                {links.map((link, idx) => (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-sm text-text underline decoration-border underline-offset-4 transition-colors hover:decoration-text"
                  >
                    {link.label}
